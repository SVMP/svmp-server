    ...
    proxySocket.on('data', function (data) {
        ...
        case UNAUTHENTICATED:
            ...
            try {
                var request = proto.readRequest(data),
                    ...
                    secureid = request.authentication.secureid;
                ...
                authenticate(cred, function (err, vm) {
                    if (vm) {
                        ...
                        proto.writeResponse({"type": "ERROR", "message": "Failed Authentication"}, proxySocket);
                    }
                });
            } catch (e) {
                console.log("Actual Error AUth: ", e);
        ...
        case VMREADY:
            ...
            try {
                ...
                console.log("Actual Error VMREADY: ", e);
                 proto.writeResponse({"type": "ERROR", "message": "Parser: Bad formed message"}, proxySocket);    
            }
            break;
        case PROXYREADY:
