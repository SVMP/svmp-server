            ...
            try {
                ...
                authenticator.authenticate(authObj).then(
                    function(obj) {
                        ...
                        winston.log('info', 'User: \'%s\' authenticated', obj.username);
                        ...
                        if(testing) {
                            ...
                            // Connect to VM
                            vmSocket.connect(config.settings.vm_port, obj.vm, function () {
                                winston.log('info', 'User: \'%s\' connected to VM: %s', obj.username, obj.vm);
                    ...
                    function(obj) {
                        ...
                        winston.log('error', 'Failed authentication. Username: %s', obj.username);

                        var error_resp = proto.writeResponse({type: 'AUTH', message: msg, authResponse: {type: "AUTH_FAIL"}});
