...
// {url:"http://localhost:8080/api/authenticate", form: {apikey: "123", userid: "dave", secureid: "", passwd: ""}};
// callback (err, vm info);
function authenticate(credentials, callback) {
    credentials.url = config.auth_server;
    // Make http request to Admin Server to validate 
    request.post(credentials, function(error, response, body) {
