...
exports.create = function (obj) {
    ...
    var s = new SessionModel({sid: token, username: obj.username, expireAt: expireDate(), lastAction: new Date()});
...
expireDate = function() {
    return new Date(new Date().getTime() + (settings.max_session_length*1000));
}
