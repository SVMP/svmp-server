...
program
    .command('volume-create <username> <base_vol_id>')
    .description('Clone a user data volume from the given base volume and associate it with the specified user.')
    .action(function(un) {
        console.log('');
...
program
    .command('volume-add <username> <volume_id>')
