...
h3. Configuration
	...
	* Follow the instructions in 'config.js' to add code to the config-local.js file, which should look like this:
...
<pre>
	...
	Make sure to set the proper settings in the fields (openstack, pam, etc...)
